...
final class ResourceActionDefinitionCollection
{
     ...
     * }>> $resourceActionsConfiguration
     * @param string[] $resourceActionsDirectories
     */
    public function __construct(array $resourceActionsConfiguration, array $resourceActionsDirectories)
    {
        $this->collectors[] = new ConfigurationCollector($resourceActionsConfiguration);
        $this->collectors[] = new AttributeCollector($resourceActionsDirectories);
    }
